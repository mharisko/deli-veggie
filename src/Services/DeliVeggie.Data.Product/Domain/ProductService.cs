...
namespace DeliVeggie.Product.Service.Domain
{
    ...
    public class ProductService : IProductService
    {
        ...
        {
            return productRepository.AddNewProductAsync(product);
        }
        ...
        {
            return productRepository.GetProductsAsync(skip, limit);
        }
        ...
        {
            return productRepository.UpdateProductAsync(productId, product);
        }
    }
}
